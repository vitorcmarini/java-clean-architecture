package br.com.alura.codechella.domian.entities.usuario;
...
public class UsuarioTest {
    @Test
    public void naoDeveCadasrtrarUsuarioComCpfNoFormatoInvalido() {
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new Usuario("123.456.789-99", "vitor", LocalDate.parse("1990-09-08"), "email@mail.com"));

        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new Usuario("123.456.78999", "vitor", LocalDate.parse("1990-09-08"), "email@mail.com"));

        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new Usuario("123456.789-99", "vitor", LocalDate.parse("1990-09-08"), "email@mail.com"));

        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new Usuario("12345678999", "vitor", LocalDate.parse("1990-09-08"), "email@mail.com"));
    }
